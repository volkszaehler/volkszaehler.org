...
(function($) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function drawSeriesLines(series) {
            ...
            function plotDashes(datapoints, xoffset, yoffset, axisx, axisy, series) {
            ...
            if (lw > 0 && sw > 0) {
                ...
                plotProxy(series.datapoints, Math.sin(angle) * (lw/2 + sw/2), Math.cos(angle) * (lw/2 + sw/2), series.xaxis, series.yaxis, series);
                ctx.lineWidth = sw/2;
                plotProxy(series.datapoints, Math.sin(angle) * (lw/2 + sw/4), Math.cos(angle) * (lw/2 + sw/4), series.xaxis, series.yaxis, series);
            }
            ...
            if (lw > 0)
                plotProxy(series.datapoints, 0, 0, series.xaxis, series.yaxis, series);
            ctx.restore();
        }
        ...
        function onMouseLeave(e) {
            if (options.grid.hoverable)
                // cpuidle@gmx.de changed event type
